      ...
      <div className="space-y-8 w-full max-w-5xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-4 border-b border-border">
            ...
            <div className="flex items-center gap-3 bg-zinc-950 dark:bg-zinc-100 p-2 px-4 rounded-xl shadow-lg border border-border/50">
               <div className="w-8 h-8 rounded-lg bg-emerald-500 flex items-center justify-center text-white">
                 <Zap className="h-5 w-5" />
               </div>
               <div>
                 <div className="text-[8px] font-black text-muted-foreground uppercase tracking-widest opacity-60 leading-none mb-1">Status</div>
                 <div className="text-[10px] font-black text-white dark:text-zinc-950 uppercase tracking-tighter leading-none">Operational</div>
               </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <Card className="relative border-none shadow-xl bg-card dark:bg-zinc-950 overflow-hidden rounded-[2rem]">
                ...
                <CardHeader className="pb-2 pt-6 px-6">
                  <CardTitle className="text-sm font-black flex items-center gap-2 text-foreground dark:text-zinc-100 uppercase tracking-tight">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                       ...
                       <Input
                         ...
                         className="h-10 bg-muted/20 border-2 border-border rounded-xl font-black text-sm outline-none"
                         placeholder="City"
                       />
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2 h-10">
                        {['petrol', 'diesel'].map((f) => (
                          <button
                            ...
                            className={`flex-1 rounded-xl text-[9px] font-black uppercase border-2 transition-all ${
                              fuelType === f ? 'bg-blue-600 border-blue-600 text-white shadow-md' : 'bg-muted/20 border-border text-muted-foreground text-foreground/50'
                            }`}
                          >
                            {f}
                          </button>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Input
                         ...
                         placeholder="110.00"
                         className="h-12 bg-muted/20 border-2 border-border rounded-xl px-4 text-xl font-black text-foreground outline-none transition-all"
                       />
                       <Button 
                         variant="ghost" 
                         size="sm" 
                ...
                <CardContent className="p-6 space-y-6">
                   ...
                   <div className="flex gap-2">
                     <Button 
                       onClick={reset}
                       variant="ghost" 
                       className="h-10 flex-1 rounded-xl bg-secondary text-[9px] font-black uppercase tracking-widest"
                     >Reset</Button>
                     <Button 
               ...
               <Card className="relative border-none shadow-2xl bg-card dark:bg-zinc-950 overflow-hidden rounded-[2.5rem]">
                 ...
                 <CardContent className="p-8 space-y-6 text-center">
                    <div className="space-y-2">
                      ...
                      <div className="text-[9px] font-black text-text-muted uppercase tracking-widest opacity-80">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="p-4 rounded-2xl bg-muted/20 border border-border">
                        ...
                        <p className="text-xl font-black">₹{results ? results.costPerKm.toFixed(2) : '0.00'}</p>
                        <span className="text-[8px] font-bold text-muted-foreground uppercase opacity-50">Per KM</span>
                      </div>
                      <div className="p-4 rounded-2xl bg-muted/20 border border-border">
                        <p className="text-[8px] font-black uppercase tracking-widest text-muted-foreground mb-1">Volume</p>
                        <p className="text-xl font-black">{results ? results.fuelReq.toFixed(1) : '0.0'}L</p>
                        <span className="text-[8px] font-bold text-muted-foreground uppercase opacity-50">Total</span>
                      </div>
                    </div>
